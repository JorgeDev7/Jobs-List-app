export default function Job({ jobData, fields, setFields }) {

    const { company, logo, newJob, featured, position, role, level, postedAt, contract, location, languages, tools } = jobData;
